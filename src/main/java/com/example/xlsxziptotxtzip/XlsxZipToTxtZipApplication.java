package com.example.xlsxziptotxtzip;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

/**
 * The main entry point for the Xlsx Zip To Txt Zip application with Couchbase integration.
...
public class XlsxZipToTxtZipApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(XlsxZipToTxtZipApplication.class, args);
	}
